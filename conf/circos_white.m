...
for i=1:246
	fid=fopen(strcat(wd,'conf/circos/circos_prob_1_p001_color_white_',num2str(i),'.conf'),'w');
	...
	fprintf(fid,'<<include conf/ideogram_white.conf>>\n');
	fprintf(fid,'<<include conf/plot/plot_%d.conf>>\n',i);
